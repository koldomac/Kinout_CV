...
KINOUT.View = (function(knt, undefined) {
    ...
    var init = function(config) {
        ...
        //Analize navigator
		var message = navigator.userAgent.match( /(iPhone|iPad|iPod|Android)/i ) ? 'Toca la pantalla para navegar' : 'Utiliza las teclas de cursor para navegar';
		knt.Dom.append('section:first-child', '<br/><h4 class="transparent">('+message+')</h4>');
    };
